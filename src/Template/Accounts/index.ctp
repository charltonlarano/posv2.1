...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <?php if ($forAdmin === true){ echo "<li>"; echo $this->Html->link(__('New Account'), ['action' => 'add']); echo "</li>"; } ?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?php if ($forAdmin === true) {echo $this->Html->link(__('Edit'), ['action' => 'edit', $account->id]); } ?>
                    <?php if ($forAdmin === true) {echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $account->id], ['confirm' => __('Are you sure you want to delete # {0}?', $account->id)]); } ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
